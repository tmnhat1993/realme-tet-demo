...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(18)(module), __webpack_require__(4)))
...
var _preorderData = _interopRequireDefault(__webpack_require__(14));
...
function () {
  ...
  function Common() {
    ...
    this.preOrderInfor = _preorderData.default;
    this.currentPreorder = 'realme-c2'; // Preorder Elements
    ...
    this.$searchStoreButton = this.$preorderSection.find('.pre-order-footer .cta'); // Partner Elements
  ...
  _createClass(Common, [{
    ...
    key: "SetupMobileSpecialMenu",
    value: function SetupMobileSpecialMenu() {
      var _this = this;
      ...
      this.$specialHeaderMenuToggler.on('click', function (e) {
        if (_this.allowSpecialMenuInteraction) {
          _this.allowSpecialMenuInteraction = false;

          if (!_this.$specialHeader.hasClass('show-menu')) {
            _this.$specialHeader.addClass('show-menu');

            _this.$specialHeaderMenu.slideDown('fast', function () {
              _this.allowSpecialMenuInteraction = true;
            });
          } else {
            _this.$specialHeader.removeClass('show-menu');

            _this.$specialHeaderMenu.slideUp('fast', function () {
              _this.allowSpecialMenuInteraction = true;
            });
          }
        }
      });
      this.$closeSpecialMenu.on('click', function () {
        if (_this.allowSpecialMenuInteraction) {
          _this.allowSpecialMenuInteraction = false;
    ...
    value: function GameRuleModalSetup() {
      ...
      this.$openGameRuleModal.on('click', function () {
        ...
        _this2.$gameRuleModal.addClass('active');
      });
      this.$closeGameRuleModal.on('click', function () {
        $('body').removeClass('show-modal');

        _this2.$gameRuleModal.removeClass('active');
      });
    }
  }, {
    key: "GameResultModalSetup",
    value: function GameResultModalSetup() {
      var _this3 = this;
      ...
      this.$closeGameResultModal.on('click', function () {
        $('body').removeClass('show-modal');

        _this3.$gameResultModal.removeClass('active');
      });
    }
  }, {
    key: "GameHistoryModalSetup",
    value: function GameHistoryModalSetup() {
      var _this4 = this;
      ...
      this.$closeGameHistoryModal.on('click', function () {
        $('body').removeClass('show-modal');

        _this4.$gameHistoryModal.removeClass('active');
      });
      this.$openGameHistoryModal.on('click', function () {
        $('body').addClass('show-modal');

        _this4.$gameHistoryModal.addClass('active');
      });
    }
  }, {
    ...
    value: function PreorderModalSetup() {
      ...
      this.$preorderModal = $('.pre-order-modal'); // Open And Close Modal Events

      this.$openPreorderModal.on('click', function (e) {
        var targetPhone = $(e.target).data('preorder-phone');

        _this5.UpdatePreorderModal(targetPhone);

        $('body').addClass('show-modal');

        _this5.$preorderModal.addClass('active');
      });
      this.$closePreorderModal.on('click', function () {
        $('body').removeClass('show-modal');

        _this5.$preorderModal.removeClass('active');
      }); // Phone and Version Picker Behavior

      this.$phoneListToggler.on('click', function (e) {
        if (!_this5.$preorderPhoneList.hasClass('active')) {
          // Close Below Selector
          _this5.$preorderVersionList.slideUp('fast', function () {
            _this5.$preorderVersionList.removeClass('active');
          });

          _this5.$preorderPhoneList.slideDown('fast', function () {
            _this5.$preorderPhoneList.addClass('active');
          });
        } else {
          _this5.$preorderPhoneList.slideUp('fast', function () {
            _this5.$preorderPhoneList.removeClass('active');
          });
        }
      });
      this.$versionListToggler.on('click', function (e) {
        if (!_this5.$preorderVersionList.hasClass('active')) {
          _this5.$preorderVersionList.slideDown('fast', function () {
            _this5.$preorderVersionList.addClass('active');
          });
        } else {
          _this5.$preorderVersionList.slideUp('fast', function () {
            _this5.$preorderVersionList.removeClass('active');
      ...
      $('body').on('click', '.pre-order-dialog .pre-order-content .phone-item', function (e) {
        var phoneModel = $(e.target).data('phone-model');

        _this5.UpdatePreorderModal(phoneModel);

        $(e.target).parents('.phones-list').slideUp('fast', function () {
          $(e.target).parents('.phones-list').removeClass('active');
        });
      });
      $('body').on('click', '.pre-order-dialog .pre-order-content .version-item', function (e) {
        var versionName = $(e.target).html();
        var versionIndex = $(e.target).data('version-index');

        _this5.UpdateKALink(versionIndex);

        _this5.$searchStoreButton.attr('id', "Popup Search Store ".concat(_this5.preOrderInfor[_this5.currentPreorder]['name'], " ").concat(_this5.preOrderInfor[_this5.currentPreorder]['versions'][versionIndex]['name'], " Button"));

        _this5.$preorderVersionName.html(versionName);

        $(e.target).parents('.version-list').slideUp('fast', function () {
    ...
    value: function LoginModalSetup() {
      ...
      this.allowSwitchForm = true; // Modal Control

      this.$openLoginModal.on('click', function () {
        $('body').addClass('show-modal');

        _this6.$loginModal.addClass('active');
      });
      this.$closeLoginModal.on('click', function () {
        $('body').removeClass('show-modal');

        _this6.$loginModal.removeClass('active');
      }); // Form Switching

      this.$toSignupBtn.on('click', function () {
        if (_this6.allowSwitchForm) {
          _this6.allowSwitchForm = false;

          _this6.$loginForm.fadeOut('fast', function () {
            _this6.$signupForm.fadeIn('fast');

            _this6.allowSwitchForm = true;
          });
        }
      });
      this.$toLoginBtn.on('click', function () {
        if (_this6.allowSwitchForm) {
          _this6.allowSwitchForm = false;

          _this6.$signupForm.fadeOut('fast', function () {
            _this6.$loginForm.fadeIn('fast');
    ...
    key: "UpdatePreorderModal",
    value: function UpdatePreorderModal() {
      var _this7 = this;

      var phoneType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'reamle-c2';
      var phoneData = this.preOrderInfor[phoneType]; // Update Current Preorder Phone

      this.currentPreorder = phoneType;
      this.$searchStoreButton.attr('id', "Popup Search Store ".concat(this.preOrderInfor[phoneType]['name'], " ").concat(this.preOrderInfor[phoneType]['versions'][0]['name'], " Button")); // Update Phone Name

      this.$activePhoneName.html(this.preOrderInfor[phoneType]['name']); // Render Version

      var versionsData = this.preOrderInfor[phoneType]['versions'];
      this.$preorderVersionName.html(this.preOrderInfor[phoneType]['versions'][0]['name']);
      this.$preorderVersionList.html('');
      versionsData.forEach(function (element, index) {
        _this7.$preorderVersionList.append("<li class=\"version-item\" data-version-index=\"".concat(index, "\">").concat(element['name'], "</li>"));
      });
      this.UpdateKALink(0);
    }
  }, {
    key: "UpdateKALink",
    value: function UpdateKALink() {
      var versionIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      var KAData = this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['links'];
      this.$viettelHolder = this.$partnerList.find('.partner-item.viettel');
      this.$vinproHolder = this.$partnerList.find('.partner-item.vinpro');
      this.$lazadaHolder = this.$partnerList.find('.partner-item.lazada');
      ...
      if (KAData['tgdd'] !== '') {
        ...
        this.$tgddHolder.append("<a class=\"link-wrapper track-this-button\" \n                  href=\"".concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['links']['tgdd'], "\"\n                  id=\"Popup ").concat(this.currentPreorder, " ").concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['name'], " TGDD Buynow Button\">\n                <img src=\"img/partners/tgdd.png\">\n              </a>"));
      ...
      if (KAData['fpt'] !== '') {
        this.$fptHolder.html('');
        this.$fptHolder.append("<a class=\"link-wrapper track-this-button\"\n                   href=\"".concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['links']['fpt'], "\"\n                  id=\"Popup ").concat(this.currentPreorder, " ").concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['name'], " FPTShop Buynow Button\">\n                <img src=\"img/partners/fpt.png\">\n              </a>"));
        this.$fptHolder.show();
      } else {
        this.$fptHolder.hide();
      }
      ...
      if (KAData['vinpro'] !== '') {
        ...
        this.$vinproHolder.append("<a class=\"link-wrapper track-this-button\"\n                   href=\"".concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['links']['vinpro'], "\"\n                  id=\"Popup ").concat(this.currentPreorder, " ").concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['name'], " Vinpro Buynow Button\">\n                <img src=\"img/partners/vinpro.png\">\n              </a>"));
      ...
      if (KAData['viettel'] !== '') {
        ...
        this.$viettelHolder.append("<a class=\"link-wrapper track-this-button\"\n                   href=\"".concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['links']['viettel'], "\"\n                  id=\"Popup ").concat(this.currentPreorder, " ").concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['name'], " Viettel Buynow Button\">\n                <img src=\"img/partners/viettel.png\">\n              </a>"));
      ...
      if (KAData['lazada'] !== '') {
        ...
        this.$lazadaHolder.append("<a class=\"link-wrapper track-this-button\"\n                   href=\"".concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['links']['lazada'], "\"\n                  id=\"Popup ").concat(this.currentPreorder, " ").concat(this.preOrderInfor[this.currentPreorder]['versions'][versionIndex]['name'], " Lazada Buynow Button\">\n                  <img src=\"img/partners/lazada.png\">\n              </a>"));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax__ = __webpack_require__(19);
...
var _miniGame = _interopRequireDefault(__webpack_require__(39));
...
$(document).ready(function () {
  ...
  if ($('.section-wheel-spin').length > 0) {
    var miniGame = new _miniGame.default();
  }
...
var _default = {
  ...
  'realme-c2': {
    ...
    'versions': [{
      'name': '2GB - 32GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-c2-2gb-32gb',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-c2-2gb-32gb',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-c2-2gb-32gb-pid141269.html',
        'lazada': ''
      }
    }, {
      'name': '2GB - 16GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-c2-16gb',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-c2',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-c2-16gb-pid136724.html',
        'lazada': ''
      }
    }, {
      'name': '3GB - 32GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-c2-16gb',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-c2-3gb-32gb',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-c2-32gb-pid136273.html',
        'lazada': ''
      }
    }]
  },
  ...
  'realme-5': {
    ...
    'versions': [{
      'name': '3GB - 64GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-5',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-5-3gb-64gb-pid140680.html',
        'lazada': ''
      }
    }, {
      'name': '4GB - 128GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5-4gb',
        'fpt': '',
        'vinpro': '',
        'viettel': '',
        'lazada': ''
  ...
  'realme-5-pro': {
    ...
    'versions': [{
      'name': '4GB - 128GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5-pro',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-5-pro',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-5-pro-4gb-128gb-pid140682.html',
        'lazada': ''
      }
    }, {
      'name': '8GB - 128GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5-pro-8gb',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-5-pro-8gb-128gb',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-5-pro-8gb-128gb-pid141690.html',
        'lazada': ''
      }
    }]
  },
  ...
  'realme-5s': {
    ...
    'versions': [{
      'name': '4GB - 128GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5s',
        'fpt': '',
        'vinpro': '',
        'viettel': '',
        'lazada': ''
  ...
  'realme-5i': {
    ...
    'versions': [{
      'name': '3GB - 32GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5i?fbclid=IwAR2a2pRuyLwzxBnn5GKPOzMVQVf9H6RzAmIJjHzH43QZa8q1VkdlYFPB4dE',
        'fpt': '',
        'vinpro': '',
        'viettel': '',
        'lazada': ''
      ...
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-5i?fbclid=IwAR2a2pRuyLwzxBnn5GKPOzMVQVf9H6RzAmIJjHzH43QZa8q1VkdlYFPB4dE',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-5i-4gb-64gb',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-5i-4gb-64gb-pid144235.html',
        'lazada': ''
      }
    }]
  },
  ...
  'realme-xt': {
    ...
    'versions': [{
      'name': '4GB - 128GB',
      'links': {
        'tgdd': 'https://www.thegioididong.com/dtdd/realme-xt',
        'fpt': 'https://fptshop.com.vn/dien-thoai/realme-xt',
        'vinpro': '',
        'viettel': 'https://viettelstore.vn/dien-thoai/realme-xt-pid142913.html',
        'lazada': ''
      }
    }]
  }
...
var _productsListing = _interopRequireDefault(__webpack_require__(16));

var _banner = _interopRequireDefault(__webpack_require__(17));

var _comparision = _interopRequireDefault(__webpack_require__(21));

var _news = _interopRequireDefault(__webpack_require__(23));

var _flashsale = _interopRequireDefault(__webpack_require__(24));

var _youtubePlayer = _interopRequireDefault(__webpack_require__(25));
...
function () {
  ...
  function Home() {
    ...
    window.rmFlashSaleListener = new _utils.pageListener(); // Common Behavior

    var common = new _common.default(); // Individual Section

    var banner = new _banner.default();
    var productListing = new _productsListing.default();
    var comparision = new _comparision.default();
    var news = new _news.default();
    var flashsale = new _flashsale.default();
    /* Sections */
    ...
    if ($('#music-event-holder').length > 0) {
      this.playerYT = (0, _youtubePlayer.default)('music-event-holder', {
        videoId: '8Ft5ew4bBIg',
        // Default Clip
        playerVars: {
          disablekb: 1,
  ...
  _createClass(Home, [{
    ...
    value: function SetupHomePage() {
      ...
      $(window).on('scroll', function (e) {
        if ((0, _utils.reachSection)(_this.$flashsaleSection)) {
          if (!_this.animationStatus.flashsale) {
            _this.animationStatus.flashsale = true;
...
function () {
  ...
  _createClass(ProductListing, [{
    ...
    value: function SetupProductSlider() {
      var _this = this;

      this.$productSlider = $('.products-slider-holder .products-slider');
      this.$productSlider.on('init reinit', function () {
        _this.$realmeXTBlock = _this.$productSliderSection.find('.product-item.realme-xt');
        _this.$realme5sBlock = _this.$productSliderSection.find('.product-item.realme-5s');
        _this.$realme5ProBlock1 = _this.$productSliderSection.find('.product-item.realme-5-pro.realme-5-pro-4-128');
        _this.$realme5ProBlock2 = _this.$productSliderSection.find('.product-item.realme-5-pro.realme-5-pro-8-128');
        _this.$realme5Block1 = _this.$productSliderSection.find('.product-item.realme-5.realme-5-3-64');
        _this.$realme5Block2 = _this.$productSliderSection.find('.product-item.realme-5.realme-5-4-128');
        _this.$realmeC2Block1 = _this.$productSliderSection.find('.product-item.realme-c2.c2-2-16');
        _this.$realmeC2Block2 = _this.$productSliderSection.find('.product-item.realme-c2.c2-2-32');
        _this.$realmeC2Block3 = _this.$productSliderSection.find('.product-item.realme-c2.c2-3-32');

        _this.SetupSingleProductCountdown(_this.$realmeXTBlock, 'Feb 1, 2020 23:59:59');

        _this.SetupSingleProductCountdown(_this.$realme5sBlock, 'Feb 1, 2020 23:59:59');

        _this.SetupSingleProductCountdown(_this.$realme5ProBlock1, 'Feb 1, 2020 23:59:59');

        _this.SetupSingleProductCountdown(_this.$realme5ProBlock2, 'Feb 1, 2020 23:59:59');

        _this.SetupSingleProductCountdown(_this.$realme5Block1, 'Feb 1, 2020 23:59:59');

        _this.SetupSingleProductCountdown(_this.$realme5Block2, 'Feb 1, 2020 23:59:59');

        _this.SetupSingleProductCountdown(_this.$realmeC2Block2, 'Feb 1, 2020 23:59:59');
      });
    ...
    key: "SetupProductColorChanger",
    value: function SetupProductColorChanger() {
    ...
    key: "SetupSingleProductColor",
    value: function SetupSingleProductColor($targetElement) {
      var $nameSwitcher = $targetElement.find('.name-switcher');
      var $name1 = $nameSwitcher.find('.phone-name.name-1');
      var $name2 = $nameSwitcher.find('.phone-name.name-2');
      var $phoneImgHolder = $targetElement.find('.phones-img-holder');
      var $colorImg1 = $phoneImgHolder.find('.color-1');
      var $colorImg2 = $phoneImgHolder.find('.color-2');
    ...
    key: "SetupProductCountdown",
    value: function SetupProductCountdown() {}
  }, {
    key: "SetupSingleProductCountdown",
    value: function SetupSingleProductCountdown($targetElement, endDate) {
      var countDownDate = new Date(endDate).getTime();
      var $daysValue = $targetElement.find('.discount-countdown .clock-value .value.days'); // let $hoursValue = $targetElement.find('.discount-countdown .clock-value .value.hours');
      ...
      $daysValue.html(days); // setInterval(() => {
...
function () {
  ...
  function Banner() {
    ...
    this.$mainContentLayer = this.$bannerSection.find('.context-layer'); // Flowers Blossom Effect Elements
  ...
  _createClass(Banner, [{
    ...
    value: function bindEvents() {
      ...
      this.SetupBanner();
      $('body').on('finish-loaded', function () {
        _this.DoBannerAnimation();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function SetupBanner() {
      ...
      _TweenMax.TweenMax.set([this.$decorationBackLayer, this.$decorationFrontLayer], {
        y: window.innerWidth * 0.04,
        opacity: 0
      });

      if (this.isMobile) {
        _TweenMax.TweenMax.set([this.$phonesLayer], {
          y: window.innerWidth * 0.03,
          opacity: 0
        });

        _TweenMax.TweenMax.set([this.$mainContentLayer], {
          y: window.innerWidth * 0.03,
          opacity: 0
        });
      } else {
      ...
      _TweenMax.TweenMax.set([this.$celebsLayer], {
        y: window.innerWidth * 0.03,
        opacity: 0
      });

      this.bannerAnimationTimeline = new TimelineMax({
        paused: true,
        onComplete: function onComplete() {
          _this2.$fireworkLayer.addClass('animating');

          _this2.DoFlowerAnimation();
        }
      });
      this.bannerAnimationTimeline.add([_TweenMax.TweenMax.to(this.$decorationBackLayer, 0.85, {
        opacity: 1,
        y: 0
      }), _TweenMax.TweenMax.to(this.$decorationFrontLayer, 0.85, {
        opacity: 1,
        y: 0,
        delay: 0.2
      })], '+=0.2');
      this.bannerAnimationTimeline.add([_TweenMax.TweenMax.to(this.$celebsLayer, 0.65, {
        opacity: 1,
        y: 0
      }), _TweenMax.TweenMax.to(this.$phonesLayer, 0.65, {
        opacity: 1,
        y: 0
      })]);
      this.bannerAnimationTimeline.to(this.$mainContentLayer, 0.65, {
        x: 0,
        y: 0,
        opacity: 1
      }, '+=0.05');
      ...
      _TweenMax.TweenMax.set([this.$flowerElem1, this.$flowerElem2, this.$flowerElem3, this.$flowerElem4, this.$flowerElem5, this.$flowerElem6, this.$flowerElem7, this.$flowerElem8], {
        scale: 0.25,
        autoAlpha: 0
      }); // Banner Animation Flowers Group 1


      this.flowerGroup1Timeline = new TimelineMax({
        paused: true,
        repeat: -1,
        repeatDelay: 0.85
      });
      this.flowerGroup1Timeline.add([_TweenMax.TweenMax.to(this.$flowerElem1, 1, {
        rotation: 80,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _TweenMax.TweenMax.to(this.$flowerElem2, 1, {
        delay: 0.2,
        rotation: -30,
        autoAlpha: 1,
        scale: 1,
      ...
      this.flowerGroup1Timeline.add([_TweenMax.TweenMax.to(this.$flowerElem1, 0.55, {
        rotation: 100,
        autoAlpha: 0,
        scale: 1.1,
        ease: _gsap.Power4.easeIn
      }), _TweenMax.TweenMax.to(this.$flowerElem2, 0.49, {
        delay: 0.1,
        rotation: -40,
        autoAlpha: 0,
        scale: 1.075,
        ease: _gsap.Power4.easeIn
      })], '+=1.75'); // Banner Animation Flowers Group 2

      this.flowerGroup2Timeline = new TimelineMax({
        paused: true,
        repeat: -1,
        repeatDelay: 1.15
      });
      this.flowerGroup2Timeline.add([_TweenMax.TweenMax.to(this.$flowerElem3, 1.1, {
        rotation: 80,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _TweenMax.TweenMax.to(this.$flowerElem4, 0.9, {
        delay: 0.2,
        rotation: -30,
        autoAlpha: 1,
        scale: 1,
      ...
      this.flowerGroup2Timeline.add([_TweenMax.TweenMax.to(this.$flowerElem3, 0.65, {
        rotation: 100,
        autoAlpha: 0,
        scale: 1.1,
        ease: _gsap.Power4.easeIn
      }), _TweenMax.TweenMax.to(this.$flowerElem4, 0.49, {
        delay: 0.3,
        rotation: -40,
        autoAlpha: 0,
        scale: 1.075,
        ease: _gsap.Power4.easeIn
      })], '+=1.75'); // Banner Animation Flowers Group 3

      this.flowerGroup3Timeline = new TimelineMax({
        paused: true,
        repeat: -1,
        repeatDelay: 1.35
      });
      this.flowerGroup3Timeline.add([_TweenMax.TweenMax.to(this.$flowerElem5, 1.1, {
        rotation: 80,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _TweenMax.TweenMax.to(this.$flowerElem6, 0.9, {
        delay: 0.2,
        rotation: -30,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _TweenMax.TweenMax.to(this.$flowerElem7, 0.9, {
        delay: 0.2,
        rotation: -35,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _TweenMax.TweenMax.to(this.$flowerElem8, 0.8, {
        delay: 0.2,
        rotation: -32,
        autoAlpha: 1,
        scale: 1,
      ...
      this.flowerGroup3Timeline.add([_TweenMax.TweenMax.to(this.$flowerElem5, 0.65, {
        rotation: 100,
        autoAlpha: 0,
        scale: 1.1,
        ease: _gsap.Power4.easeIn
      }), _TweenMax.TweenMax.to(this.$flowerElem6, 0.49, {
        delay: 0.3,
        rotation: -40,
        autoAlpha: 0,
        scale: 1.075,
        ease: _gsap.Power4.easeIn
      }), _TweenMax.TweenMax.to(this.$flowerElem7, 0.49, {
        delay: 0.3,
        rotation: -45,
        autoAlpha: 0,
        scale: 1.075,
        ease: _gsap.Power4.easeIn
      }), _TweenMax.TweenMax.to(this.$flowerElem8, 0.39, {
        delay: 0.3,
        rotation: -42,
        autoAlpha: 0,
        scale: 1.075,
    ...
    key: "DoFlowerAnimation",
    value: function DoFlowerAnimation() {
      // Flower Effect Play
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase__ = __webpack_require__(20);
...
var _phoneData = _interopRequireDefault(__webpack_require__(22));
...
function () {
  ...
  function Comparision() {
    ...
    this.phoneDetails = _phoneData.default;
    ...
    this.$aspectDetailList = this.$comparisionGroup.find('.product-detail .feature-detail'); // Current Phone Mode For Each Group

    this.currentGroup1 = this.$compareGroup1.data('current-phone');
    this.currentGroup2 = this.$compareGroup2.data('current-phone'); // Feature List For Each Group

    this.$featureListHolder1 = this.$compareGroup1.find('.product-detail .feature-detail');
    this.$featureListHolder2 = this.$compareGroup2.find('.product-detail .feature-detail'); // Phone Image

    this.$group1PhoneImage = this.$compareGroup1.find('.product-detail .phone-image .img-holder img');
    this.$group2PhoneImage = this.$compareGroup2.find('.product-detail .phone-image .img-holder img'); // Version List
    ...
    this.$group2CurrentVersion = this.$compareGroup2.find('.version-active .value'); // Price Holder

    this.$group1PriceHolder = this.$compareGroup1.find('.price-detail');
    this.$group2PriceHolder = this.$compareGroup2.find('.price-detail'); // Landing Page Link Holder

    this.$group1CurrentLandingPage = this.$compareGroup1.find('.seemore-holder .seemore');
    this.$group2CurrentLandingPage = this.$compareGroup2.find('.seemore-holder .seemore'); // Buy Now Button Holder

    this.$group1BuynowButton = this.$compareGroup1.find('.buynow-holder .buynow-btn');
    this.$group2BuynowButton = this.$compareGroup2.find('.buynow-holder .buynow-btn'); // Selection Items

    this.$selectionItems = this.$comparisionSection.find('.comparision-selection .selection-list .selection-item'); // Current Aspect To Compare
  ...
  _createClass(Comparision, [{
    ...
    key: "SetupComparision",
    value: function SetupComparision() {
    ...
    value: function UpdateGroup() {
      ...
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'realme-c2';
      ...
      if (group == 1) {
        ...
        this.$group1BuynowButton.attr('id', "Comparision Left ".concat(this.phoneDetails[data]['name'], " Buynow Button"));
        ...
        this.$group2BuynowButton.attr('id', "Comparision Right ".concat(this.phoneDetails[data]['name'], " Buynow Button"));
    ...
    value: function UpdateVersion() {
      ...
      switch (group) {
        case 1:
          // Get Version Data
          var versionData1 = this.phoneDetails[this.currentGroup1]['versions']; // Update Current Name

          this.$group1CurrentVersion.html(versionData1[0]['name']); // Update Version Select List

          this.$group1VersionList.html('');
          versionData1.forEach(function (element, index) {
            _this.$group1VersionList.append("<li class=\"version-item\" data-version=\"".concat(index, "\">").concat(element['name'], "</li>"));
          });
        ...
        default:
          // Get Version Data
          var versionData2 = this.phoneDetails[this.currentGroup2]['versions']; // Update Current Name

          this.$group2CurrentVersion.html(versionData2[0]['name']); // Update Version Select List

          this.$group2VersionList.html('');
          versionData2.forEach(function (element, index) {
            _this.$group2VersionList.append("<li class=\"version-item\" data-version=\"".concat(index, "\">").concat(element['name'], "</li>"));
          });
    ...
    value: function UpdatePrice() {
      ...
      if (group == 1) {
        ...
        if (this.phoneDetails[this.currentGroup1]['versions'][index]['is-sale']) {
          this.$group1PriceHolder.html(this.phoneDetails[this.currentGroup1]['versions'][index]['sale-price-html']);
        } else {
          // Original Price
          this.$group1PriceHolder.html(this.phoneDetails[this.currentGroup1]['versions'][index]['original-price-html']);
        }
      } else {
        // Product Group 2 Is Sale
        if (this.phoneDetails[this.currentGroup2]['versions'][index]['is-sale']) {
          this.$group2PriceHolder.html(this.phoneDetails[this.currentGroup2]['versions'][index]['sale-price-html']);
        } else {
          // Original Price
          this.$group2PriceHolder.html(this.phoneDetails[this.currentGroup2]['versions'][index]['original-price-html']);
        }
      }
    }
  }, {
    ...
    value: function UpdateFeature() {
      ...
      var group1List = this.phoneDetails[this.currentGroup1][this.currentAspect];
      var group2List = this.phoneDetails[this.currentGroup2][this.currentAspect];
      this.$featureListHolder1.html('');
      group1List.forEach(function (element) {
        _this2.$featureListHolder1.append("<li class=\"feature-item\">".concat(element, "</li>"));
      });
      this.$featureListHolder2.html('');
      group2List.forEach(function (element) {
        _this2.$featureListHolder2.append("<li class=\"feature-item\">".concat(element, "</li>"));
      });
    }
  }, {
    key: "EventSetup",
    value: function EventSetup() {
      var _this3 = this;

      /* === Changing Phone Model === */
      // Common Elements
      this.$modelToggleBtn = this.$comparisionGroup.find('.select-phone-wrapper .caret'); // Common Elements Event

      this.$modelToggleBtn.on('click', function (e) {
        var slideTarget = $(e.target).siblings('.phone-list, .version-list');

        if (!slideTarget.hasClass('active')) {
          // Other Listing Block
          $('.phone-list.active , .version-list.active').removeClass('active').slideUp('fast'); // Target Element Slide Down

          slideTarget.addClass('active').slideDown('fast');
        } else {
      ...
      this.$group1PhoneSelection = this.$compareGroup1.find('.phone-list .phone-item'); // Events Group 1
      // Phone Model Events

      this.$group1PhoneSelection.on('click', function (e) {
        var newPhoneValue = $(e.target).data('phone-model');
        var phoneContext = $(e.target).html();

        _this3.$group1CurrentPhone.html(phoneContext);

        $(e.target).parents('.phone-list').removeClass('active').slideUp('fast');

        _this3.UpdateGroup(1, newPhoneValue);
      }); // Versions Events

      $('body').on('click', '.comparision-group.group-1 .version-list', function (e) {
        var slideTarget = $(e.target).parents('.version-list');
        slideTarget.removeClass('active').slideUp('fast');

        var versionData = _this3.phoneDetails[_this3.currentGroup1]['versions'][$(e.target).data('version')]['name'];

        _this3.$group1CurrentVersion.html(versionData);

        _this3.UpdatePrice(1, $(e.target).data('version'));
      ...
      this.$group2PhoneSelection = this.$compareGroup2.find('.phone-list .phone-item'); // Events Group 2

      this.$group2PhoneSelection.on('click', function (e) {
        var newPhoneValue = $(e.target).data('phone-model');
        var phoneContext = $(e.target).html();

        _this3.$group2CurrentPhone.html(phoneContext);

        $(e.target).parents('.phone-list').removeClass('active').slideUp('fast');

        _this3.$group2CurrentPhone.html(phoneContext);

        _this3.UpdateGroup(2, newPhoneValue);
      }); // Versions Events

      $('body').on('click', '.comparision-group.group-2 .version-list', function (e) {
        var slideTarget = $(e.target).parents('.version-list');
        slideTarget.removeClass('active').slideUp('fast');

        var versionData = _this3.phoneDetails[_this3.currentGroup2]['versions'][$(e.target).data('version')]['name'];

        _this3.$group1CurrentVersion.html(versionData);

        _this3.UpdatePrice(2, $(e.target).data('version'));
      }); // Changing Compare Aspect

      this.$selectionItems.on('click', function (e) {
        if (!$(e.target).hasClass('active')) {
          // Switch Active Aspect
          _this3.$selectionItems.removeClass('active');

          $(e.target).addClass('active');
          _this3.currentAspect = $(e.target).data('aspect'); // Run Update Function

          _this3.UpdateFeature();
        }
      });
    }
  }]);
...
var _default = {
  // Realme 5
  'realme-5': {
    'image-link': 'img/phones/5-blue.png',
    'name': 'realme 5',
    'landing-page': 'https://realmemobile.vn/realme-5/',
    'is-sale': true,
    'versions': [{
      'name': '3GB/64GB',
      'is-sale': true,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 3,990,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 3,390,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 3,990,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }, {
      'name': '4GB/128GB',
      'is-sale': true,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 4,990,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 4,490,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 4,990,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }],
    'specs': ['Bộ 4 Camera 12MP AI', 'Snapdragon 665 AIE', 'Pin khủng 5000mAh', 'Màn hình giọt nước cải tiến 6.5"', 'Thiết kế mặt cắt pha lê', 'ColorOS 6'],
    'camera': ['Camera chính 12MP AI', 'Khẩu độ f/1.8', 'Zoom số 10X', 'Camera góc siêu rộng 119° 8MP', 'Hỗ trợ kết hợp siêu chụp đêm', 'Camera chụp chân dung 2MP', 'Camera góc siêu cận 2MP', 'Quay phim 4K', 'Quay Slomotion 960fps'],
    'size-performance': ['Dài: 164.4mm', 'Rộng: 75.6mm', 'Dày: 9.3mm', 'Trọng lượng: 198g', 'Chip xử lý Snapdragon 665 AIE', 'Pin 5000mAh', 'Sạc 10W (5V, 2A)'],
    'design': ['Thiết kế vân cắt pha lê', 'Pha Lê Xanh, Pha Lê Tím', 'Màn hình giọt sương cải tiến 6.5" HD+', 'Tỷ lệ màn hình 89%', 'Cổng Micro USB'],
    'inside': ['realme 5', 'Cáp Micro USB', 'Củ sạc', 'Vỏ nhựa bảo vệ', 'Que chọc SIM', 'Hướng dẫn sử dụng', 'Thông tin sản phẩm (Bao gồm phiếu bảo hành)']
  },
  // Realme 5 Pro
  'realme-5-pro': {
    'image-link': 'img/phones/5pro-purple.png',
    'name': 'realme 5 Pro',
    'landing-page': 'https://realmemobile.vn/realme-5-pro/',
    'is-sale': true,
    'versions': [{
      'name': '4GB/128GB',
      'is-sale': true,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 5,990,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 5,290,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\">5,990,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }, {
      'name': '8GB/128GB',
      'is-sale': true,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 6,990,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 6,490,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 6,990,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }],
    'specs': ['Bộ 4 Camera 48MP Sony', 'Snapdragon 712 AIE', 'Sạc nhanh VOOC 3.0', 'Camera trước 16MP', 'Màn hình FullHD+', 'Công nghệ HyberBoost 2.0'],
    'camera': ['Camera chính 48MP', 'Cảm biến Sony IMX 586', '6 lớp thấu kính', 'Camera góc siêu rộng 119° 8MP', 'Hỗ trợ kết hợp siêu chụp đêm', 'Camera chụp chân dung 2MP', 'Camera góc siêu cận 2MP', 'Quay phim 4K', 'Quay Slomotion 960fps'],
    'size-performance': ['Dài: 157mm', 'Rộng: 74.2mm', 'Dày: 8.9mm', 'Trọng lượng: 184g', 'Chip xử lý Snapdragon 712 AIE', 'Pin 4035mAh', 'Sạc nhanh VOOC 3.0 20W'],
    'design': ['Thiết kế vân cắt pha lê', 'Xanh Thảo Nguyên, Xanh Đại Dương', 'Màn hình giọt sương 6.3" FHD+', 'Tỷ lệ màn hình 90.6%', 'Cổng Type C'],
    'inside': ['realme 5 Pro', 'Cáp Type-C', 'Củ sạc nhanh VOOC', 'Vỏ nhựa bảo vệ', 'Que chọc SIM', 'Hướng dẫn sử dụng', 'Thông tin sản phẩm (Bao gồm phiếu bảo hành)']
  },
  // Realme XT
  'realme-xt': {
    'image-link': 'img/phones/realme-xt.png',
    'landing-page': 'https://realmemobile.vn/realme-xt/',
    'versions': [{
      'name': '8GB/128GB',
      'is-sale': true,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 7,990,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 7,690,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 7,990,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }],
    'specs': ['Bộ 4 Camera 64MP AI', 'Snapdragon 712 AIE', 'Sạc nhanh VOOC 3.0', 'Màn hình AMOLED FHD+', 'Cảm ứng vân tay trong màn hình', 'Thiết kế mặt lưng 3D'],
    'camera': ['Bộ 4 camera 64MP AI', 'với Góc siêu rộng và Siêu cận', 'Camera Trước 16MP Sony', 'Camera chính 64MP', 'Camera góc siêu rộng 8MP', 'Hỗ trợ chế độ Siêu chụp đêm', 'Camera chân dung 2MP', 'Camera siêu cận 2MP', 'Quay phim 4K', 'Quay Slomotion 960fps'],
    'size-performance': ['Chiều dài: 158.7mm', 'Chiều rộng: 75.2mm', 'Chiều dày: 8.6mm', 'Trọng lượng: ≈183g (có pin)', 'Chip Qualcomm Snapdragon 712 AIE', 'Pin 4000mAh', 'Hỗ trợ sạc nhanh VOOC 5V, 4A'],
    'design': ['Thiết kế mặt lưng 3D vân Sáng chữ X', 'Trân châu trắng. Ngọc trai xanh.', 'Vân tay trong màn hình.', 'Kích thước: 6.4-inch (16.2cm)', 'Chất liệu: Super AMOLED. Tỉ lệ: 91.9%', 'Cổng sạc type C'],
    'inside': ['realme XT', 'Dây cáp Type-C', 'Củ sạc VOOC', 'Ốp lưng bảo vệ', 'Que lấy SIM', 'Sách hướng dẫn', 'Thông tin sản phẩm và thẻ bảo hành']
  },
  // Realme C2
  'realme-c2': {
    'image-link': 'img/phones/c2-blue.png',
    'name': 'realme C2',
    'landing-page': 'https://realmemobile.vn/realme-c2/',
    'is-sale': true,
    'versions': [{
      'name': '2GB/32GB',
      'is-sale': true,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 2,390,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 2,090,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                  <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                  <div class=\"new-price\">\n                    <span class=\"new-price-value\">\n                        gi\xE1 g\u1ED1c: <span class=\"new-price\"> 2,390,000 VN\u0110</span>\n                    </span>\n                </div>"
    }, {
      'name': '3GB/32GB',
      'is-sale': false,
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 2,690,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 2,690,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                    <span class=\"new-price-value\">\n                        gi\xE1 g\u1ED1c: <span class=\"new-price\"> 2,690,000 VN\u0110</span>\n                    </span>\n                </div>"
    }],
    'specs': ['Camera kép AI', 'Thiết kế vân kim cương', 'Màn hình giọt sương tràn viền', 'Mở khoá nhận diện khuôn mặt', 'Pin lớn 4000mAh'],
    'camera': ['Camera kép 13MP + 2MP', 'Bắt tiêu điểm nhanh PDAF', 'Khẩu độ f/2.2', '5 lớp thấu kính', 'Camera trước 5MP', 'Điểm ảnh 1.12 μm', 'Video720p/1080p 30fps'],
    'size-performance': ['Chiều ngang: 73.8mm', 'Chiều dài: 154.4mm', 'Chiều dày: 8.4mm', 'Khối lượng: 166g', 'Pin 4000mAH', 'Chip Mediatek Helio P22'],
    'design': ['Thiết kế vân kim cương', 'Kim cương đen, Kim cương xanh', 'Màn hình giọt sương tràn viền', 'Kích thước: 15.5cm (6.1 Inch)', 'Diện tích hiển thị: 89.35%', 'Tỷ lệ màn hình: 19.5:9', 'Độ phân giải: HD+ 1560x720 pixel'],
    'inside': ['Điện thoại', 'Củ sạc', 'Cáp sạc Micro USB', 'Giấy bảo hành', 'Hướng dẫn sử dụng', 'Que chọc SIM', 'Miếng dán màn hình']
  },
  // Realme 5s
  'realme-5s': {
    'image-link': 'img/phones/5s-red.png',
    'name': 'realme 5s',
    'landing-page': 'https://realmemobile.vn/realme-5s/',
    'is-sale': true,
    'versions': [{
      'is-sale': true,
      'name': '4GB/128GB',
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 4,990,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 4,790,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                       &nbsp;<span class=\"old-price-value\">&nbsp;</span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 4,990,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }],
    'specs': ['Bộ 4 Camera 48MP AI', 'Snapdragon 665 AIE', 'Pin khủng 5000mAh', 'Màn hình giọt nước', 'cải tiến 6.5"', 'Màu sắc mới: Pha Lê Đỏ', 'ColorOS 6'],
    'camera': ['Camera chính 48MP AI', 'Khẩu độ f/1.8', 'Zoom số 10X', 'Camera góc siêu rộng 119° 8MP', 'Hỗ trợ kết hợp siêu chụp đêm', 'Camera chụp chân dung 2MP', 'Camera góc siêu cận 2MP', 'Quay phim 4K', 'Quay Slomotion 960fps'],
    'size-performance': ['Dài: 164.4mm', 'Rộng: 75.6mm', 'Dày: 9.3mm', 'Trọng lượng: 198g', 'Chip xử lý Snapdragon 665 AIE', 'Pin 5000mAh', 'Sạc 10W (5V, 2A)'],
    'design': ['Thiết kế vân cắt pha lê', 'Pha Lê Đỏ, Pha Lê Xanh', 'Màn hình giọt sương cải tiến 6.5" HD+', 'Tỷ lệ màn hình 89%', 'Cổng Micro USB'],
    'inside': ['realme 5s', 'Cáp Micro USB', 'Củ sạc', 'Vỏ nhựa bảo vệ', 'Que chọc SIM', 'Hướng dẫn sử dụng', 'Thông tin sản phẩm (Bao gồm phiếu bảo hành)']
  },
  // Realme 5i
  'realme-5i': {
    'image-link': 'img/jan/fs-banner/5i-green.png',
    'name': 'realme 5s',
    'landing-page': 'https://realmemobile.vn/realme-5i/',
    'versions': [{
      'is-sale': true,
      'name': '3GB/32GB',
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 3,690,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 3,490,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            &nbsp;<span class=\"old-price-value\">&nbsp;</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 3,690,000 VN\u0110</span>\n                        </span>\n                    </div>"
    }, {
      'is-sale': true,
      'name': '4GB/64GB',
      'sale-price-html': "<div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"old-price-value\"> 4,290,000 VN\u0110</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 khuy\u1EBFn m\xE3i: <span class=\"new-price\"> 3,990,000 VN\u0110</span>\n                        </span>\n                    </div>",
      'original-price-html': "\n                    <div class=\"old-price\">\n                        <span class=\"old-price-value\">\n                             &nbsp;<span class=\"old-price-value\">&nbsp;</span>\n                        </span>\n                    </div>\n                    <div class=\"new-price\">\n                        <span class=\"new-price-value\">\n                            gi\xE1 g\u1ED1c: <span class=\"new-price\"> 4,290,000 VN\u0110</span><br>\n                        </span>\n                    </div>"
    }],
    'specs': ['Bộ 4 Camera 12MP AI', 'Thiết kế mặt lưng vân sáng ánh dương', 'Snapdragon 665 AIE', 'Pin khủng 5000mAh', 'Màn hình giọt sương', 'cải tiến 6.5"', 'ColorOS 6"'],
    'camera': ['Camera chính 12MP AI', 'Khẩu độ f/1.8', 'Zoom số 10X', 'Camera góc siêu rộng 119° 8MP', 'Hỗ trợ kết hợp siêu chụp đêm', 'Camera chụp chân dung 2MP', 'Camera góc siêu cận 2MP', 'Quay phim 4K', 'Camera Selfie 8MP'],
    'size-performance': ['Dài: 164.4mm', 'Rộng: 75.6mm', 'Dày: 9.3mm', 'Trọng lượng: 198g', 'Chip xử lý Snapdragon 665 AIE', 'Pin 5000mAh', 'Sạc 10W (5V, 2A)'],
    'design': ['Thiết kế vân sáng ánh dương', 'Xanh lá cây, Xanh nước biển', 'Màn hình giọt sương cải tiến 6.5" HD+', 'Tỷ lệ màn hình 89%', 'Cổng Micro USB'],
    'inside': ['realme 5i', 'Cáp Micro USB', 'Củ sạc', 'Que chọc SIM', 'Hướng dẫn sử dụng', 'Thông tin sản phẩm (Bao gồm phiếu bảo hành)']
  }
};
exports.default = _default;
...
function () {
  ...
  function FlashSaleDetail() {
    _classCallCheck(this, FlashSaleDetail);
    ...
    this.$flashSaleCountdownHolder = this.$flashSaleDetail.find('.product-flashsale-countdown'); // Update Element
    // Cloud Element

    this.$cloudElement = $('.section-fs-detail .effect-layer .cloud-layer'); // Countdown Element
  ...
  _createClass(FlashSaleDetail, [{
    ...
    value: function FlashSaleInit() {
      ...
      // }, 1000);
      // Set Init State
      _TweenMax.TweenMax.set(this.$phoneImgHolder, {
        opacity: 0,
        y: window.innerWidth * 0.035
      });

      _TweenMax.TweenMax.set(this.$phoneName, {
        opacity: 0,
        x: window.innerWidth * 0.05
      });

      _TweenMax.TweenMax.set(this.$phoneSlogan, {
        opacity: 0,
        x: -window.innerWidth * 0.05
      });

      _TweenMax.TweenMax.set(this.$flashSaleDetailImage, {
        opacity: 0,
        y: window.innerWidth * 0.017
      });

      _TweenMax.TweenMax.set(this.$flashSaleCountdownHolder, {
        opacity: 0,
        y: window.innerWidth * 0.012
      });

      _TweenMax.TweenMax.set(this.$cloudElement, {
        opacity: 0
      });

      this.flashSaleAnimation = new TimelineMax({
        paused: true,
        onComplete: function onComplete() {
          _this.SetupFlashSale();
        }
      });
      this.flashSaleAnimation.add('animation start');
      this.flashSaleAnimation.to(this.$cloudElement, 0.75, {
        opacity: 1
      });
      this.flashSaleAnimation.to(this.$phoneImgHolder, 0.75, {
        opacity: 1,
        y: 0
      });
      ...
      this.flashSaleAnimation.to(this.$flashSaleDetailImage, 0.65, {
        opacity: 1,
        y: 0,
        ease: Power2.easeOut
      }, '-=0.25');
      this.flashSaleAnimation.to(this.$flashSaleCountdownHolder, 0.65, {
        opacity: 1,
        y: 0,
        ease: Power2.easeOut
      }, '-=0.17');
    ...
    key: "FlashSaleAnimation",
    value: function FlashSaleAnimation() {
      var _this2 = this;

      rmFlashSaleListener.on('flashsale-anim', function () {
        _this2.flashSaleAnimation.play();
      });
    }
  }, {
    key: "SetupFlashSale",
    value: function SetupFlashSale() {
      var _this3 = this;
      ...
      this.$switchBlueBtn.on('click', function () {
        if (!_this3.$switchBlueBtn.hasClass('active')) {
          // If Timeout is still running
          clearInterval(_this3.SwitchColorTimeout);

          _this3.$switchRedBtn.removeClass('active');

          _this3.$phoneRedImg.removeClass('active');

          _this3.$phoneBlueImg.addClass('active');

          _this3.$switchBlueBtn.addClass('active');

          _this3.currentColor = 'blue';

          _this3.ActiveColorTimeout();
        }
      });
      this.$switchRedBtn.on('click', function () {
        if (!_this3.$switchRedBtn.hasClass('active')) {
          // If Timeout is still running
          clearInterval(_this3.SwitchColorTimeout);

          _this3.$phoneBlueImg.removeClass('active');

          _this3.$switchBlueBtn.removeClass('active');

          _this3.$switchRedBtn.addClass('active');

          _this3.$phoneRedImg.addClass('active');

          _this3.currentColor = 'red';
    ...
    key: "ActiveColorTimeout",
    value: function ActiveColorTimeout() {
      var _this4 = this;

      this.SwitchColorTimeout = setInterval(function () {
        switch (_this4.currentColor) {
          case 'red':
            _this4.$switchRedBtn.removeClass('active');

            _this4.$phoneRedImg.removeClass('active');

            _this4.$phoneBlueImg.addClass('active');

            _this4.$switchBlueBtn.addClass('active');

            _this4.currentColor = 'blue';
            break;

          case 'blue':
            _this4.$phoneBlueImg.removeClass('active');

            _this4.$switchBlueBtn.removeClass('active');

            _this4.$switchRedBtn.addClass('active');

            _this4.$phoneRedImg.addClass('active');

            _this4.currentColor = 'red';
            break;
        }
      }, 2400);
    } // SetupCountDownClock(){
...
exports.default = FlashSaleDetail;
...
var _api = _interopRequireDefault(__webpack_require__(40));
...
function () {
  ...
  _createClass(MiniGame, [{
    ...
    key: "SetupMiniPage",
    value: function SetupMiniPage() {
      this.AddRotateEvent(); // GET Global Data

      this.GetPrizeWinners(); // Buy live button

      this.BuyLiveSetup(); // Sharing Button Setup

      this.SharingButtonSetup(); // Authentication Setup
    ...
    key: "StartRotate",
    value: function StartRotate(result) {
      var _this = this;

      // Win Prize
      switch (result.data.type) {
        case '100xu':
          _gsap.TweenMax.to(this.$gameWheelPrize, 10, {
            rotation: 3600 + 292,
            ease: _gsap.Power4.easeOut,
            onComplete: function onComplete() {
    ...
    value: function RotateAPI() {
      ...
      var api = new _api.default({
        ...
        success: function success(res) {
          _this2.StartRotate(res); // Update Live without calling API


          _this2.userState.data.lives -= 1; // After minus the live

          if (_this2.userState.data.lives > 0) {
            // If live > 0
            _this2.$remainingLive.html(_this2.userState.data.lives);
          } else {
    ...
    key: "AddRotateEvent",
    value: function AddRotateEvent() {
      var _this3 = this;

      this.$spinTheWheelBtn.on('click', function () {
        // If is not logged in and
        if (_this3.userState.isUserLoggedIn) {
          // If amount if live still larger than 0
          if (_this3.userState.data.lives > 0) {
            // Block Interaction When Spinning
            if (_this3.allowSpinning) {
              _this3.allowSpinning = false; // Wheel already spinned at least 1 time, do the reset animation

              if (_this3.wheelIsSpinned) {
                _gsap.TweenMax.to(_this3.$gameWheelPrize, 1, {
                  rotation: 3600,
                  onComplete: function onComplete() {
                    _gsap.TweenMax.set(_this3.$gameWheelPrize, {
                      rotation: 0
                    });
                ...
                _this3.wheelIsSpinned = true;

                _this3.RotateAPI();
              }
            }
          } else {
            _this3.ShowResultDialog({
              data: {
                type: 'out-of-live'
              }
            });
          ...
          _this3.$loginModal.addClass('active');
        }
      });
    }
  }, {
    key: "BuyLiveSetup",
    value: function BuyLiveSetup() {
      var _this4 = this;

      this.$buyLiveButton.on('click', function () {
        if (_this4.userState.isUserLoggedIn) {
          var api = new _api.default({
            ...
            success: function success(res) {
              ...
              if (res.is_success) {
                _this4.userState.data.lives = res.data.lives;
                _this4.userState.data.coin = res.data.coin;

                _this4.$remainingCoinHolder.html(_this4.userState.data.coin);

                _this4.$remainingLive.html(_this4.userState.data.lives); // Life is now > 0, hide buying button


                $('.user-still-have-live').show();
                $('.user-is-out-of-live').hide();
              } else {
                _this4.ShowResultDialog({
                  data: {
                    type: 'buy-life-failed'
                  }
                });
              }
            },
    ...
    key: "SharingButtonSetup",
    value: function SharingButtonSetup() {
      var _this5 = this;

      this.$facebookSharingButton.on('click', function () {
        FB.ui({
          method: 'share',
          hashtag: '#TếtREALME',
          ...
          if (response !== undefined) {
            // Success
            _this5.ProcessSharing();
          } else {
            _this5.ShowResultDialog({
              data: {
                type: 'sharing-failed'
              }
            });
    ...
    value: function ProcessSharing() {
      ...
      var api = new _api.default({
        ...
        success: function success(res) {
          if (res.is_success) {
            _this6.ShowResultDialog({
              data: {
                type: 'sharing-success'
              }
            });

            _this6.userState.data.coin += 1000;

            _this6.$remainingCoinHolder.html(_this6.userState.data.coin);
          } else {
            _this6.ShowResultDialog({
              data: {
                type: 'sharing-already'
              }
            });
          }
        },
    ...
    key: "RegisterSetup",
    value: function RegisterSetup() {
      var _this7 = this;

      jQuery.validator.addMethod("checkPhoneNumber", function (value, element) {
        var phone = _this7.$signupForm.find('[name="phone"]').val();
      ...
      this.$registerSubmitButton.click(function () {
        _this7.SubmitSignup();
      });
    ...
    key: "SetupFlowerEffect",
    value: function SetupFlowerEffect() {
      this.$flowerHolder = $('.section-wheel-spin .flower-layer'); // Flower Group 1

      this.$flowerElement1 = this.$flowerHolder.find('.flower-1');
      this.$flowerElement2 = this.$flowerHolder.find('.flower-3'); // Flower Group 2
      ...
      _gsap.TweenMax.set([this.$flowerElement1, this.$flowerElement2, this.$flowerElement3, this.$flowerElement4, this.$flowerElement5], {
        scale: 0.25,
        autoAlpha: 0
      }); // Banner Animation Flowers Group 1
      ...
      this.flowerGroup1Timeline.add([_gsap.TweenMax.to(this.$flowerElement1, 1, {
        rotation: 80,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _gsap.TweenMax.to(this.$flowerElement2, 1, {
        delay: 0.2,
        rotation: -30,
        autoAlpha: 1,
        scale: 1,
      ...
      this.flowerGroup1Timeline.add([_gsap.TweenMax.to(this.$flowerElement1, 0.55, {
        rotation: 100,
        autoAlpha: 0,
        scale: 1.1,
        ease: _gsap.Power4.easeIn
      }), _gsap.TweenMax.to(this.$flowerElement2, 0.49, {
        delay: 0.1,
        rotation: -40,
        autoAlpha: 0,
        scale: 1.075,
      ...
      this.flowerGroup2Timeline.add([_gsap.TweenMax.to(this.$flowerElement3, 1.1, {
        rotation: 80,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _gsap.TweenMax.to(this.$flowerElement4, 0.9, {
        delay: 0.2,
        rotation: -30,
        autoAlpha: 1,
        scale: 1,
        ease: _gsap.Power4.easeOut
      }), _gsap.TweenMax.to(this.$flowerElement5, 0.93, {
        delay: 0.24,
        rotation: -35,
        autoAlpha: 1,
        scale: 1,
      ...
      this.flowerGroup2Timeline.add([_gsap.TweenMax.to(this.$flowerElement3, 0.65, {
        rotation: 100,
        autoAlpha: 0,
        scale: 1.1,
        ease: _gsap.Power4.easeIn
      }), _gsap.TweenMax.to(this.$flowerElement4, 0.49, {
        delay: 0.3,
        rotation: -40,
        autoAlpha: 0,
        scale: 1.075,
        ease: _gsap.Power4.easeIn
      }), _gsap.TweenMax.to(this.$flowerElement5, 0.45, {
        delay: 0.32,
        rotation: -45,
        autoAlpha: 0,
        scale: 1.075,
    ...
    value: function LoginSetup() {
      ...
      this.$loginSubmitButton.click(function () {
        _this8.SubmitLogin();
      });
    }
  }, {
    ...
    value: function SubmitLogin() {
      ...
      if (isValid) {
        var api = new _api.default({
          ...
          success: function success(res) {
            _this9.LoggedInProcess(res.data.user);
          },
          err: function err(_err2, textStatus, errorThrown) {
            _this9.$loginFormFeedback.html('Email hoặc số điện thoại không hợp lệ, quý khách vui lòng thử lại hoặc bấm vào <b>Đăng ký ngay</b> để tạo tài khoản').show();
          }
        });
      }
    }
      ...
      if (isValid) {
        var api = new _api.default({
          ...
          success: function success(res) {
            ...
            _this10.$signupFormFeedback.html('').hide();

            _this10.LoggedInProcess(res.data.user);
          },
          err: function err(_err3, textStatus, errorThrown) {
            var errInfo = JSON.parse(_err3.responseText); // console.log(JSON.parse(err.responseText));

            if (errInfo.data.messages.length > 0) {
              _this10.$signupFormFeedback.html('');

              errInfo.data.messages.forEach(function (message) {
                switch (message) {
                  case 'Email has already been taken':
                    _this10.$signupFormFeedback.append("<span>Email \u0111\xE3 t\u1ED3n t\u1EA1i</span><br>");

                    break;

                  case "Phone number has already been taken":
                    _this10.$signupFormFeedback.append("<span>S\u1ED1 \u0111i\u1EC7n tho\u1EA1i \u0111\xE3 t\u1ED3n t\u1EA1i</span><br>");

                    break;

                  default:
                    _this10.$signupFormFeedback.append("<span>\u0110\u0103ng k\xFD kh\xF4ng th\xE0nh c\xF4ng, qu\xFD kh\xE1ch vui l\xF2ng th\u1EED l\u1EA1i</span><br>");
              ...
              _this10.$signupFormFeedback.show();
            }
          }
        });
      }
    ...
    value: function LogoutSetup() {
      ...
      this.$loggedOutButton.on('click', function () {
        _this11.LoggedOutProcess();
      });
    }
  }, {
    key: "AutoLogin",
    value: function AutoLogin() {
      ...
      if (localStorage.getItem('token')) {
        ...
        var api = new _api.default({
          ...
          success: function success(res) {
            // console.log(res)
            _this12.$loginModal.removeClass('active');

            _this12.LoggedInProcess(res.data.user);
          },
          err: function err(_err4, textStatus, errorThrown) {// console.log('login failed', err, textStatus, errorThrown);
          }
        });
      } else {
    ...
    key: "LoggedInProcess",
    value: function LoggedInProcess() {
      var loginInfo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      this.$loginModal.removeClass('active'); // Hide Logged out elements & Show loggedIn elements

      $('.user-is-logged-out').hide();
      $('.user-is-logged-in').show(); // console.log(loginInfo);
      ...
      this.$remainingLive.html(this.userState.data.lives); // Remaining Live Processing
    ...
    key: "LoggedOutProcess",
    value: function LoggedOutProcess() {
      ...
      this.$spinningHistory.html(''); // Reset The Wheel

      this.wheelIsSpinned = false;

      _gsap.TweenMax.set(this.$gameWheelPrize, {
        rotation: 0
      });
    }
    /* ==== ULTILITIES === */
    ...
    value: function ShowResultDialog(result) {
      this.allowSpinning = true;
      this.$resultModal.addClass('active'); // console.log(result);
    ...
    value: function GetSpinHistory() {
      ...
      var api = new _api.default({
        ...
        success: function success(res) {
          ...
          _this13.$spinningHistory.html('');

          res.data.histories.forEach(function (element) {
            var spinTime = new Date(element.created_at);
            var spinTimeString = "".concat((spinTime.getDate() < 10 ? '0' : '') + spinTime.getDate(), "/").concat((spinTime.getMonth() + 1 < 10 ? '0' : '') + (spinTime.getMonth() + 1), "/").concat(spinTime.getFullYear(), " - ").concat((spinTime.getHours() < 10 ? '0' : '') + spinTime.getHours(), ":").concat((spinTime.getMinutes() < 10 ? '0' : '') + spinTime.getMinutes(), "\n          - ").concat(_this13.FilterPrizeName(element.description));

            _this13.$spinningHistory.append("\n            <li class=\"spinning-history-item\">\n              ".concat(spinTimeString, "\n            </li>\n          "));
          });
        }
      });
    }
    ...
    key: "GetPrizeWinners",
    value: function GetPrizeWinners() {
      var _this14 = this;
      ...
      var api = new _api.default({
        ...
        success: function success(res) {
          // console.log(res.data);
          _this14.$luckyList.html(''); // Update History Holder, only 5 on the array


          var loadAmount = res.data.length > 5 ? 5 : res.data.length;

          for (var i = 0; i < loadAmount; i++) {
            _this14.$luckyList.append("<li>\n              ".concat(res.data[i].phone, " - \n              <span class=\"capitalize\">").concat(res.data[i].name, "</span> \u0111\xE3 tr\xFAng\n              ").concat(_this14.FilterPrizeName(res.data[i].type), "\n            </li>"));
          }
        }
      });
    }
    ...
    key: "FilterPrizeName",
    value: function FilterPrizeName() {
